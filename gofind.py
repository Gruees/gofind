...
print(colored('Announcement:','red'))
print(colored('This tools for search information public,','blue'))
print(colored('Enjoying this tools For gathering information user','blue'))
print(colored('my e-mail: fernandojakiya@gmail.com','blue'))
print(os.linesep)
